...
rnlpPostCI_lm_new <- function(niter, burnin, thinning, y, x, p, r, tau, a_phi, b_phi, prior, thinit, use_thinit, phi, knownphi) {
    .Call(`_mombf_rnlpPostCI_lm_new`, niter, burnin, thinning, y, x, p, r, tau, a_phi, b_phi, prior, thinit, use_thinit, phi, knownphi)
}
