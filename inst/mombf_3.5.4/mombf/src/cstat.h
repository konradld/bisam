...
void rnlpPost_lm_new(double *ans, int niter, int burnin, int thinning, double *y, double *x, int n, int p, int r, double tau, double a_phi, double b_phi, int prior, arma::dvec &thinit, bool use_thinit, double phi, bool knownphi); // Lucas: amended to incorperate phinit and thinit, otherwise same as above
